...
TEST_CASE("FileStore key", "[filestore]") {
    ...
    REQUIRE(to_string(k2) == "987e3458ef4567623f54aab8765a63c0a78e62e3a54976d52ee358c76e543fefdd180000");
}
...
TEST_CASE("FileStore file paths", "[filestore]") {
    ...
    REQUIRE(store1.get_file_path(k2) == fs1.path() / "a3" / "7b" / "2f29ec7ef15a39b20015382bef6a45b28a3b2ffe1862ca4f92ef7a3f2872dd180000");
    ...
    REQUIRE(store2.get_file_path(k2) == fs2.path() / "a3" / "7b" / "2f" / "29ec7ef15a39b20015382bef6a45b28a3b2ffe1862ca4f92ef7a3f2872dd180000");
}
